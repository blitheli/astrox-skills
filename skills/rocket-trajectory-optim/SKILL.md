...
curl "${BASE_URL}/Rocket/TrajectoryOptim" \
  ...
  --data-binary "@skills/rocket-trajectory-optim/fixtures/trajectory-optim-cz2d-min.json"
```
...
| 文件 | 用途简述 |
| --- | --- |
| `skills/rocket-trajectory-optim/fixtures/trajectory-optim-cz2d-min.json` | CZ-2D 级模型,关闭优化 Profiles,返回关键点弹道参数 |
