...
namespace ASTROX.Astrogator.Tests
{
    public partial class AstrogatorTests
    {
        ...
        结果:
            ...
            约束条件为1e-6°，最终的TA的误差为1e-6°

        */
        [TestMethod()]
        public void EarthPointMass_Periapsis_250331()
        {
            //  输入json文件的路径
            ...
            //  读取输入参数(json)
            string fp = Path.Combine(filePath0, "EarthPointMass_Periapsis_250331.json");
          ...
          "SemiMajorAxis": 9686497.505537344,
          "Eccentricity": 0.2600177958875236,
          "Inclination": 0,
          "RAAN": 0,
          "ArgOfPeriapsis": 299.73095567115547,
          "MeanAnomaly": 2.3104976830562497E-08,
          "TrueAnomaly": 4.0743840552624E-08,
          "Period": 9487.704220855558
        },
            */
            //  最后一段
            var seg3 = output.MainSequenceResults[1];
            Assert.AreEqual("2000-01-01T16:58:58", seg3.FinalState.Epoch.Split('.')[0]);
            ...
            Assert.AreEqual(0, seg3.FinalState.Keplerian.TrueAnomaly, 1e-7);
        }
  ...
  "MainSequenceResults": [
    ...
    },
    {
      ...
      "FinalState": {
        "Epoch": "2000-01-01T16:58:58.76781381190813Z",
        "CoordSystemName": "Earth Inertial",
        "Cartesian": {
          "X": 3554729.739824347,
          "Y": -6224288.4062213125,
          "Z": 0,
          "Vx": 7268.835914755553,
          "Vy": 4151.277303515328,
          "Vz": 0
        },
        "Keplerian": {
          "ElementType": "Osculating",
        ...
        "Spherical": {
          "RightAscension": 299.73095571189936,
          "Declination": 0,
          "RadiusMagnitude": 7167835.774277527,
          "HorizFPA": 8.407910800417339E-09,
          "VelocityAzimuth": 90,
          "VelocityMagnitude": 8370.727495643474
        },
        "DryMass": 100,
        "FuelMass": 900,
        "Cd": 2.2,
      ...
      "DurationSec": 18002.951813811902,
      "Results": {
        "Vel": 8370.727495643474,
        "Duration1": 18002.951813811902,
        "TrueAnomaly": 4.0743840552624E-08
      }
    }
         */
