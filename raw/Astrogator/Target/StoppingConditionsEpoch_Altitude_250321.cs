...
namespace ASTROX.Astrogator.Tests
{
    public partial class AstrogatorTargetTests
    {
        ...
        */
        [TestMethod()]
        public void StoppingConditionsEpoch_Altitude_250321()
        {
            //  输入json文件的路径
            ...
            //  读取输入参数(json)
            string fp = Path.Combine(filePath0, "StoppingConditionsEpoch_Altitude_250321.json");
  ...
  "MainSequenceResults": [
    {
      ...
      "OperatorResults": [
        {
          ...
          "ControlParameters": [
            {
              "Enable": true,
              "Name": "StoppingConditions.Epoch1",
              "InitialValue": "2000-01-02T12:00:00.000Z",
              "FinalValue": "2000-01-02T11:46:04.313754696820979Z",
              "Correction": -835.6862453031858,
              "LastUpdate": -0.004042305795451284,
          ...
          "Results": [
            {
              ...
              "ParentName": "Propagate",
              "CurrentValue": "2000000.0000931271",
              "Unit": null,
              "Difference": 9.312713518738747E-05,
              "ScalingMethod": "NoScaling",
              "ScalingValue": 1,
              "Tolerance": 0.1,
              "Weight": 1,
      ...
      "SegmentResults": [
        ...
        },
        {
          ...
          "FinalState": {
            "Epoch": "2000-01-02T11:46:04.313754696806427Z",
            "CoordSystemName": "Earth Inertial",
            "Cartesian": {
              "X": 8186585.925500723,
              "Y": 1781288.9929449144,
              "Z": 0,
              "Vx": 87.548801087134,
              "Vy": 7348.111931293428,
              "Vz": 0
            },
            "Keplerian": {
              "ElementType": "Osculating",
              "GravitationalParameter": 398600441500000,
              "SemiMajorAxis": 9686497.505540377,
              "Eccentricity": 0.2600177958876763,
              "Inclination": 0,
              "RAAN": 0,
              "ArgOfPeriapsis": 299.73095567093924,
              "MeanAnomaly": 45.97338747297469,
              "TrueAnomaly": 72.54448622801692,
              "Period": 9487.704220860012
            },
            "Spherical": {
              "RightAscension": 12.275441898956178,
              "Declination": 0,
              "RadiusMagnitude": 8378137.000073061,
              "HorizFPA": 12.958057993362857,
              "VelocityAzimuth": 90,
              "VelocityMagnitude": 7348.633461221796
            },
            "DryMass": 100,
            "FuelMass": 900,
            "Cd": 2.2,
            ...
            "DragArea": 20,
            "SRPArea": 20,
            "Geodetic_Latitude": -0.0017606963947605872,
            "Geodetic_Longitude": 94.31961215696045,
            "Geodetic_Altitude": 2000000.0000931271,
            "Geocentric_Latitude": -0.0017517233213538426,
            "Geocentric_Longitude": 94.31961215696045
          },
          "DurationSec": 85628.4977546968,
          "Results": {
            "Altitude": 2000000.0000931271
          }
        }
      ],
    ...
    "CzmlPositions": [
      {
        ...
        "interval": "2000-01-01T11:58:55.816Z/2000-01-02T11:46:04.313Z",
        "cartesian": null,
        "cartesianVelocity": [
          0,
          8000000,
